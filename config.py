...
__C.D_MODEL_LIST_G = [600,512,256,128,64,32,16,8,3] 
__C.N_HEAD_LIST_G = [8,8,8,8,4,4,4,4]
__C.D_K_LIST_G = [150,128,64,32,16,8,4,4] 
...
__C.D_MODEL_LIST_D = [300,256,128,64,32,16,8,3] 
__C.N_HEAD_LIST_D = [8,8,4,4,4,4,2]
__C.D_K_LIST_D = [64,64,32,16,8,4,4] 
