...
__C.BATCH_SIZE = 128
__C.LEARNING_RATE_G = 4e-6
__C.LEARNING_RATE_D_1 = 4e-6
__C.LEARNING_RATE_D_2 = 3e-6
...
# Model d_1
__C.ENC_PARAM_D_1 = edict({'n_layers':4, 'd_model':__C.D_WORD_VEC, 'd_inner_scale':4, 'n_head':4, 
                'd_k':32, 'd_v':32, 'dropout':0.1, 'scale_emb':False})
__C.DEC_PARAM_D_1 = edict({'n_layers':4, 'd_model':__C.D_WORD_VEC, 'd_inner_scale':4, 'n_head':4, 
                'd_k':32, 'd_v':32, 'dropout':0.1, 'scale_emb':False})
__C.FC_LIST_D_1 = [__C.D_WORD_VEC, 1]

# Model d_2
__C.ENC_PARAM_D_2 = edict({'n_layers':3, 'd_model':__C.D_WORD_VEC, 'd_inner_scale':4, 'n_head':4, 
                'd_k':32, 'd_v':32, 'dropout':0.2, 'scale_emb':False})
__C.DEC_PARAM_D_2 = edict({'n_layers':3, 'd_model':__C.D_WORD_VEC, 'd_inner_scale':4, 'n_head':4, 
                'd_k':32, 'd_v':32, 'dropout':0.2, 'scale_emb':False})
__C.FC_LIST_D_2 = [__C.D_WORD_VEC, 1]
