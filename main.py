...
if __name__ == "__main__":
    ...
    optimizer_g = ScheduledOptim(
        torch.optim.Adam(net_g.parameters(), lr=5e-5, betas=(cfg.BETA_1, cfg.BETA_2), eps=1e-09),
    ...
    optimizer_d = ScheduledOptim(
        torch.optim.Adam(net_d.parameters(), lr=1e-5, betas=(cfg.BETA_1, cfg.BETA_2), eps=1e-09),
